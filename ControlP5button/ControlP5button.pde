 ...
 *
 * slr 02/17/2020 modify sample program to show differing colors 
 * for rollovers, button background and active states.
 *
 */
...
void setup() {
  ...
  cp5.addButton("buttonA")
     ...
     .setPosition(100,100)
     .setSize(200,19)
     .setColorActive(0xff990000)
     .setColorBackground(0xff000099)
     .setColorForeground(0xff990099)
     ;
